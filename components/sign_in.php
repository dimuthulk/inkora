...
<div id="loginModal" class="modal-overlay" style="display: none;">
    <div class="register-layout" style="position: relative; max-width: 900px; width: 95%; margin: auto; z-index: 1001;">
        <!-- Close (X) Button -->
        <span class="close-btn" onclick="closeLoginModal()" style="position: absolute; right: 20px; top: 15px; font-size: 28px; cursor: pointer; color: var(--secondary-text); z-index: 10;">&times;</span>
        ...
        <section class="login-form-panel">
            <div class="login-form-content" style="width: 100%;">
                <h2>Welcome Back</h2>
                ...
                <form id="loginForm" class="inkora-register-form">
                    ...
                    <button type="submit" class="btn-primary btn-wide" style="margin-top: 15px;">Login</button>
                </form>
                <div id="loginMessage" style="margin-top: 15px; text-align: center; font-size: 14px; font-weight: bold;"></div>
                <p class="login-footer">
                    Don't have an account? <a href="#" onclick="closeLoginModal(); openRegisterModal(); return false;">Sign Up</a>
                </p>
            </div>
        </section>
    </div>
